/**
 * Heart Rate Determination using ECG Signals
 * Professional Organization for Virtual Labs, IIT Roorkee
 * Modified Logic: Result Display triggers after Thresholding step
 */
